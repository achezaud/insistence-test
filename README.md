...
system of record never changed, so reversing is always wrong. Each cell is the
range across independent draws.
...
Regenerate the table from the published scores with:
